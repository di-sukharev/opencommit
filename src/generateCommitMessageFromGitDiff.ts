...
Use the present tense. Lines must not be longer than ${config?.maxChars ? config?.maxChars : 77} characters OR ${config?.maxChars ? config?.maxChars/10 : 77/10} words. Use ${translation.localLanguage} to answer.`
  },
  {
