...
type PromptFunction = (applicable: string, value: any, prompt: DeepPartial<PromptConfig>) => string;
...
const llmReadableRules: Record<string, PromptResolverFunction> = {
  ...
  caseRule: (key, applicable, value: string | string[]) =>
  ...
  enumRule: (key, applicable, value: string | string[]) =>
    `The ${key} should ${applicable} be one of the following values:
  - ${Array.isArray(value) ? value.join('\n  - ') : value}.`,
  enumTypeRule: (key, applicable, value: string | string[], prompt) =>
    `The ${key} should ${applicable} be one of the following values:
  - ${
    Array.isArray(value)
      ? value
...
const rulesPrompts: Record<string, PromptFunction> = {
  'body-case': (applicable: string, value: string | string[]) =>
  ...
  'footer-case': (applicable: string, value: string | string[]) =>
  ...
  'header-case': (applicable: string, value: string | string[]) =>
  ...
  'scope-case': (applicable: string, value: string | string[]) =>
  ...
  'scope-enum': (applicable: string, value: string | string[]) =>
  ...
  'subject-case': (applicable: string, value: string | string[]) =>
  ...
  'type-case': (applicable: string, value: string | string[]) =>
  ...
  'type-enum': (applicable: string, value: string | string[], prompt) =>
...
function getPrompt(
  ...
  const promptFunction = rulesPrompts[ruleName];
  if (promptFunction) {
    return promptFunction(applicable, value, prompt);
  }
